...
3. **Cài đặt thông tin Metadata của sách**
   - Hỗ trợ tuỳ chỉnh **Ngôn ngữ** (mặc định là `vi`).
   - Hỗ trợ thiết lập thông tin **Tác giả** cho tất cả các file EPUB được tạo.

4. **Xử lý văn bản & Tạo EPUB**
